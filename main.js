...
var ASM_CONSTS = {
  122088: () => { if (document.fullscreenElement) return 1; },  
 122134: () => { return document.getElementById('canvas').width; },  
 122186: () => { return parseInt(document.getElementById('canvas').style.width); },  
 122254: () => { document.exitFullscreen(); },  
 122281: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 122354: () => { if (document.fullscreenElement) return 1; },  
 122400: () => { return document.getElementById('canvas').width; },  
 122452: () => { return screen.width; },  
 122477: () => { document.exitFullscreen(); },  
 122504: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 122637: () => { return window.innerWidth; },  
 122663: () => { return window.innerHeight; },  
 122690: () => { if (document.fullscreenElement) return 1; },  
 122736: () => { return document.getElementById('canvas').width; },  
 122788: () => { return parseInt(document.getElementById('canvas').style.width); },  
 122856: () => { if (document.fullscreenElement) return 1; },  
 122902: () => { return document.getElementById('canvas').width; },  
 122954: () => { return screen.width; },  
 122979: () => { return window.innerWidth; },  
 123005: () => { return window.innerHeight; },  
 123032: () => { if (document.fullscreenElement) return 1; },  
 123078: () => { return document.getElementById('canvas').width; },  
 123130: () => { return screen.width; },  
 123155: () => { document.exitFullscreen(); },  
 123182: () => { if (document.fullscreenElement) return 1; },  
 123228: () => { return document.getElementById('canvas').width; },  
 123280: () => { return parseInt(document.getElementById('canvas').style.width); },  
 123348: () => { document.exitFullscreen(); },  
 123375: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 123433: () => { return screen.width; },  
 123458: () => { return screen.height; },  
 123484: () => { return window.screenX; },  
 123511: () => { return window.screenY; },  
 123538: () => { return window.devicePixelRatio; },  
 123574: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 123627: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 123698: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 123755: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 124011: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 124082: () => { if (document.fullscreenElement) return 1; },  
 124128: () => { return window.innerWidth; },  
 124154: () => { return window.innerHeight; },  
 124181: () => { if (document.pointerLockElement) return 1; }
};
